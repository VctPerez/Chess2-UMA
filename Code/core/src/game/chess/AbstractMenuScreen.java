...
public abstract class AbstractMenuScreen extends AbstractScreen{
    ...
    /**
     * Metodo que a�ade la animacion de salida a los elementos de la UI.
     * Cuando se pulsa un boton, van saliendo de la pantalla con un delay.
     * Una vez acaba la animaci�n se realiza la accion del bot�n gracias a {@link selectScreen}.
     * @param distance Distancia en p�xeles a desplazar
    ...
    /**
     * M�todo que a�ade la animaci�n de entrada.
